...
COMMAND_LINE="$JAVA_CMD $XMS $XMX $HAZELCAST_ADDITIONAL -jar $LIB_DIR/sonar-application-9.7.0.61563.jar"
    ...
    then
        ...
        then
            ...
            then
                ...
                pidtest=`$PSEXE -p $pid -o args | grep "sonar-application-9.7.0.61563.jar" | tail -1`
                if [ "X$pidtest" = "X" ]
                then
...
forcestopit() {
    ...
    then
      ...
      ${JAVA_CMD} -jar "lib/sonar-shutdowner-9.7.0.61563.jar"
